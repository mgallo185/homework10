...
class Settings(BaseSettings):
    ...
    smtp_username: str = Field(default='5e3376de732bdb', description="Username for SMTP server")
    smtp_password: str = Field(default='7e7a390a194863', description="Password for SMTP server")
